...
echo ('<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 images">');
    ...
    echo '<img class="img-responsive" src="' . $image . '" alt="' . $name . '" title="' . $name . '">';
    // echo '</a></div>';
    echo '<div class="imgs-label">' . $lastModified . '</div>';
    // echo '<div class="imgs-label">' . $name . ' ' . $lastModified . '</div>';
    // echo '</li>';
    echo '</div>';
}
